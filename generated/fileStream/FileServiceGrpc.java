...
@javax.annotation.Generated(
    ...
    comments = "Source: fileStream.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class FileServiceGrpc {

  private FileServiceGrpc() {}

  public static final String SERVICE_NAME = "fileStream.FileService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<fileStream.FileUploadRequest,
      fileStream.FileUploadResponse> getUploadMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "upload",
      requestType = fileStream.FileUploadRequest.class,
      responseType = fileStream.FileUploadResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<fileStream.FileUploadRequest,
      fileStream.FileUploadResponse> getUploadMethod() {
    io.grpc.MethodDescriptor<fileStream.FileUploadRequest, fileStream.FileUploadResponse> getUploadMethod;
      ...
      synchronized (FileServiceGrpc.class) {
        if ((getUploadMethod = FileServiceGrpc.getUploadMethod) == null) {
          FileServiceGrpc.getUploadMethod = getUploadMethod =
              io.grpc.MethodDescriptor.<fileStream.FileUploadRequest, fileStream.FileUploadResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "upload"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fileStream.FileUploadRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  fileStream.FileUploadResponse.getDefaultInstance()))
  ...
  public static abstract class FileServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<fileStream.FileUploadRequest> upload(
        io.grpc.stub.StreamObserver<fileStream.FileUploadResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncClientStreamingCall(
              new MethodHandlers<
                fileStream.FileUploadRequest,
                fileStream.FileUploadResponse>(
  ...
  private static abstract class FileServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return fileStream.FileStream.getDescriptor();
    }
